...
class up(nn.Module):
    def __init__(self, in_ch, out_ch, bilinear=True, use_attention=False):
        ...
        if self.use_attention:
            self.attention = Attention(F_g=in_ch // 2, F_l=in_ch // 2, F_int=64)
...
class outconv(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.conv = DepthwiseSeparableConv(in_ch, out_ch, kernel_size=1, padding=0)
